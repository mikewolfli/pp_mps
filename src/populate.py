...
class Application(Frame):
    def __init__(self, master=None):
        ...
        pg_db.connect()
        pg_db.create_tables([s_employee, operate_point, op_permission,login_log,mat_basic_info,mat_extra_info,mat_alias_info, project_schedule,prod_orders_table,powder_coated_schedule,number_counter,powder_per_unit])
